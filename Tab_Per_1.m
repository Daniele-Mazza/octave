...
axis([0 18 0 18 0 300]);axis on;grid on;grid minor on;xticks(20);yticks(20);
...
for i=1:ln
  ...
  patch('Faces',f2,'Vertices',v2,'FaceColor',[(h1/300) 0 (1-h1/300)]);view(3);
endfor  

xlabel("groups",'FontSize',20);ylabel("periods",'FontSize',20);zlabel("Atomic Radius (pm)",'FontSize',20);
title("Atomic Radius (calculated)",'FontSize',20);

for i=0.5:17.5
  text(i-0.2,7,0.6,num2str(i+0.5),'FontSize',20);   
endfor  
for i=18:-1:12
